    ...
    {	
  		 ...
  		 while(sumprice < fprice)
		{
  		 ...
  		 {	
  			 ...
  			 WebElement numberOrder = driver.findElement(By.xpath(".//*[@id='edit-checkout-completion-message']/div/p[2]/a"));
  			 numberOrder.click();
  			 System.out.println(String.format("Заказ оформлен!"));
  			 
  			 WebElement info = driver.findElement(By.cssSelector(".field.field-name-field-phone.field-type-text.field-label-above"));
  			 	((JavascriptExecutor)driver).executeScript("arguments[0].scrollIntoView();",info);
  		}
		}
    }	 
        @Attachment
